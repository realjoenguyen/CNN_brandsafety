...
if __name__ == '__main__':
    ...
    X = Math.loadtxt(dirname+'/sample_data/mnist2500_X.txt');
    labels = Math.loadtxt(dirname+'/sample_data/mnist2500_labels.txt');
    Y = tsne(X, 2, 50, 20.0);
    result = Plot.scatter(Y[:,0], Y[:,1], 20, labels);
    Plot.savefig('mnist2500_X.png')
